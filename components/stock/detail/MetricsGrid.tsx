    ...
    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
      <div className="p-5 bg-slate-950/30 rounded-2xl border border-slate-800">
        <div className="flex items-center justify-between mb-1">
          ...
          <button onClick={() => onHelp('per')} className="text-slate-600 hover:text-blue-400 text-xs min-w-[24px] min-h-[24px] flex items-center justify-center" aria-label="PER 도움말">[?]</button>
        </div>
      ...
      <div className="p-5 bg-slate-950/30 rounded-2xl border border-slate-800">
        <div className="flex items-center justify-between mb-1">
          ...
          <button onClick={() => onHelp('pbr')} className="text-slate-600 hover:text-blue-400 text-xs min-w-[24px] min-h-[24px] flex items-center justify-center" aria-label="PBR 도움말">[?]</button>
        </div>
      ...
      <div className="p-5 bg-slate-950/30 rounded-2xl border border-slate-800">
        <div className="flex items-center justify-between mb-1">
          ...
          <button onClick={() => onHelp('roe')} className="text-slate-600 hover:text-blue-400 text-xs min-w-[24px] min-h-[24px] flex items-center justify-center" aria-label="ROE 도움말">[?]</button>
        </div>
        ...
        return (
          <div className="p-5 bg-slate-950/30 rounded-2xl border border-slate-800">
            <div className="flex items-center justify-between mb-1">
              ...
              <button onClick={() => onHelp('peg')} className="text-slate-600 hover:text-blue-400 text-xs min-w-[24px] min-h-[24px] flex items-center justify-center" aria-label="PEG 도움말">[?]</button>
            </div>
