...
const HELP_CONTENTS: Record<HelpTermKey, HelpContent> = {
  ...
  rsi: {
    ...
    body: [
      ...
      '70 이상: 보통 과매수 구간이라고 불러요 (최근 14일 오름폭이 컸다는 뜻).',
      '30 이하: 보통 과매도 구간이라고 불러요 (최근 14일 내림폭이 컸다는 뜻).',
    ],
  ...
  bollinger: {
    ...
    body: [
      ...
      '하단 근접: 평소 변동 범위보다 아래쪽에 있는 상태',
      '상단 근접: 평소 변동 범위보다 위쪽에 있는 상태',
    ],
  ...
  sma: {
    ...
    body: [
      ...
      '주가가 5일선·20일선 모두 아래에 있으면 두 평균선 아래에 있는 상태예요.',
    ],
